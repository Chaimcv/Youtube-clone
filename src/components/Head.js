  ...
  return (
    <div className='grid grid-flow-col p-4 mb-1 shadow-md'>
        ...
        <div className='col-span-10 justify-center flex inline-block'>
            <input type='text' placeholder="  Search" className='w-1/2 h-10 rounded-s-full border border-slate-400' />
            <button className='border border-slate-400 h-10 rounded-e-full'><img className="w-11" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStyFE3cmdz5xct0IyrFWpbLlATgczRKuarKw&s' alt='search-icon' /></button>
        </div>
